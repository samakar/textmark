...
<html>
    <head>
        ...
        <style>
            .form-label{ display:inline-block;float:left;width:80px;padding-right:5px;text-align:left;}
        </style>
                ...
                <div  class="post" style="border-bottom:none;">
                    <xsl:choose>
                        <xsl:when test="//Confirmation='TRUE'">
                            <h2 class="title">Sale Confirmed!</h2>
                        </xsl:when>
                        <xsl:otherwise>
                            <h2 class="title">Confirm Sale</h2>                            
                       </xsl:otherwise>
                    </xsl:choose>
                    ...
                    <div style="width:480px;float:left;margin-right:30px">        
                      ...
                      <table id="table-detail" style="width:450px;margin:0px">
                        ...
                        <tr>
                            ...
                            <td>
                                <xsl:choose>
                                    <xsl:when test="//Confirmation='TRUE'">
                                        <p><b>Thank you!</b></p>
                                        <p>We informed the buyer about your book.</p>
                                        <p>After the payment, we'll send you an email about purchase details. We also give your contact information to the buyer to contact you and arrange an appointment.</p>
                                        <p>We'll pay you back as soon as the buyer confirms delivery of the book.</p>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <br/>
                        ...
                        <tfoot>
                            <tr><td colspan="2">
                                <ul>
                                    <li>We reveal your contact information only to the buyer that has paid for your book.</li>
                    ...
                    <div class="helpbox" style="float:right;width:250px;">
                        ...
                        <ol>
                            <li>The buyer pays for your book.</li>
                            <li>We give your contact information to the buyer.</li>
                            <li>The buyer will contact you to make an appointment.</li>
