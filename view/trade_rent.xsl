                ...
                <div class="post">
                    ...
                    <table id="table-detail">
                        ...
                        <tr>
                            ...
                            <td>
                                <p>
                                    Your book is not currently available for rent in campus.
                                    <xsl:choose>
                                        <xsl:when test="//Textmark/BookList='TRUE'">
                                            <xsl:choose>
                                                <xsl:when test="//Textmark/TradeStatus='None' or //Textmark/Rental='FALSE'">
                                                    ...
                                                    <br/>We informed by email as soon as it's available.
                                                    <br/>You can rent it soon for <strong>$<xsl:value-of select="//Textmark/RentPrice" /></strong>.
                                ...
                                <xsl:if test="//Chegg/RentPrice!=''">
                                    <p>Or</p>
                                    <p>Rent it from Chegg for <strong><xsl:value-of select="//Chegg/RentPrice" /></strong>.</p>
                                    <p>
                                        <form method="post" target="_blank" action="{//Chegg/RentURL}">
                                            <input type="submit" value="Rent Now"  class="form-submit-button"/>
                                        </form>
                                    </p>
                                </xsl:if>    
                            </td>
